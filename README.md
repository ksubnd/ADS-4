...
**по 05.04.2026** ![Relative date](https://img.shields.io/date/1775422800) 
...
> С помощью написанных функций провести исследование зависимости времени выполнения каждой функции от размера массива **len**. Измерить время и построить по точкам графики, соединив их отрезками прямых линий. Число точек - не менее 20. График построить в линейном и логарифмическом масштабах.

В результате, должны получиться два изображения в формате *.png*, на каждом из которых должно быть 3 линии графика. Файлы с именами **lin.png** и **log.png** должны располагаться в папке **Plots** репозитория.
